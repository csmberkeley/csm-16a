...
\qitem{Consider that last case, where we summed the squares of the elements of a vector. Try doing that for a few 2-dimensional vectors (vectors of length 2). What do you notice about the resulting answer? What about for vectors of length 3, or for vectors of any length n?}\\
