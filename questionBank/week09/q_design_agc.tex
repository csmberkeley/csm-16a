...
\ans{
	...
	Another possible solution would connect the input directly to the negative input of the comparator and use a $0.49\si{\volt}$ reference on the positive input of the comparator. Mind your polarity! Remember that part \ref{amp} has a negative relationship between its output and $V_\text{in}$.
}
