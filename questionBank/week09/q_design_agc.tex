...
\qitem\label{agc}{
	...
	\begin{itemize}
		...
		\item resistors: as many as you want
		\item ideal voltage source: $\leq 1$ not including the provided rails $\pm 5\si{\volt}$
	\end{itemize}
	design a circuit which adjusts the gain setting depending on the input level:
	$$V_\text{out} = \begin{cases}
