...
\qitem{Now we will explore a recipe to compute null spaces. Let's start with some $3\times 3$ matrices. \\
...
Consider one final matrix, $\mathbf{E} = \begin{bmatrix} 1 & -2 & -6 & 12 \\ 0 & -2 & -6 & 10 \\ 0 & 0 & 0 & 0\end{bmatrix}$. What are the vector(s) that span this nullspace?}
