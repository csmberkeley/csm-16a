...
\meta{
	Be very careful. The word ``close'' is used here, on purpose, since the kind of error has not yet been defined. When teaching this, make sure to use the word ``close''2 as intended.}
