...
\ans{ Use a resistor! The circuit would look like this, where $I_{out} = V_{ref}/R_{ref}$:
...
\meta{Make sure that students understand how this works for an arbitrary $G$. Basically, if you want a gain of $G$, then place a resistor of value $\dfrac{1}{G}$ in place of $R_{load}$. Also make sure that students understand that the output terminal of this VCCS is the output of the second op-amp.}
